...
def test_check_cont_lists (app, db):
    ...
    for item_db in db_list:
        ...
        db_mails_tels.append(all_phones_HP)
        db_mails_tels.append(all_mails_HP)
    for item_ui in ui_list:
        ui_mails_tels.append(item_ui.all_phones_from_HP)
        ui_mails_tels.append(item_ui.all_mails_from_HP)
